...
def draw_main():
    ...
    Button(window, text = "Word Generator for Grammar", font = dfont, bg = dtcolor, command = wordgram).grid(row = 4, column = 1)
...
def wordgram():
    ...
    def bwrite():
        os.chdir( 'wordgen_gram/bin/Debug' )
    ...
    def gwgen():
        ...
        print(os.getcwd())
        return
    Button(window, text = "Generate words", font = dfont, bg = dtcolor, command = gwgen).grid(row = 1, column = 2)
